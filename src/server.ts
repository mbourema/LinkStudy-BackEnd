...
const PORT = process.env.PORT || 5000; // Fonction qui se connecte à la base de données. Elle est exécutée avant de démarrer le serveur pour s'assurer que l'application est bien connectée à la base de données avant de recevoir des requêtes.
