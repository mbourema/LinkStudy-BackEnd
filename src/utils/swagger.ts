...
import swaggerJSDoc from "swagger-jsdoc"; // Bibliothèque qui permet de générer un fichier de spécification Swagger au format JSON ou YAML
//  en analysant les annotations présentes dans le code (les commentaires @swagger).
import swaggerUi from "swagger-ui-express"; // Bibliothèque qui permet d'intégrer une interface graphique pour visualiser
//  la documentation Swagger dans l'application Express.
...
export const setupSwagger = (app: Express) => {
  /** Middleware Express qui sert l'interface utilisateur Swagger à l'URL /api-docs. Il utilise swaggerUi.serve pour rendre l'interface graphique,
   *  et swaggerUi.setup(swaggerSpec) pour lier
